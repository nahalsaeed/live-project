    ...
    return (
        <div className='h-[200px] md:h-auto'>
            ...
            <div className="absolute inset-0">
                {title && subtitle ? (
                    <div className="text-white mt-20 md:mt-20 lg:mt-32 ml-24 w-[40%] items-start relative">
                        <div className={actor.className}>
                            <div className="font-thin text-lg md:text-3xl lg:text-5xl">
                                <h1>{title}</h1>
                    ...
                    <div className="text-white mt-20 md:mt-24 lg:mt-32 ml-24 w-[40%] items-start relative">
                        <div className={actor.className}>
                        <div className="font-thin text-lg md:text-3xl lg:text-5xl">
                                <h1>NORTH ISLAND</h1>
                            </div>
