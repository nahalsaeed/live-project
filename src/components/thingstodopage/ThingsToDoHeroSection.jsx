    ...
    return (
        <div className='h-[200px] md:h-auto'>
            ...
            <div className="absolute inset-0">
                {title && subtitle ? (
                    <div className="text-white mt-20 md:mt-20 lg:mt-32 2xl:mt-44 ml-24 w-[40%] items-start relative">
                        <div className={actor.className}>
                            <div className="font-thin text-lg md:text-3xl lg:text-5xl 2xl:text-7xl 2xl:ml-36 ">
                                <h1>{title}</h1>
                ...
                <div className="flex justify-center items-center h-auto mt-4 md:mt-24 2xl:mt-44 ">
